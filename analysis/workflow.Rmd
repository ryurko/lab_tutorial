...
You can the theme and [use a custom CSS file](https://jdblischak.github.io/workflowr/articles/wflow-02-customization.html) to modify
...
all files each time regardless if that analysis was done from awhile before, and
could take considerable time to re-run. 
